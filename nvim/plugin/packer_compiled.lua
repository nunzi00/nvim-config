...
vim.cmd [[au FileType php ++once lua require("packer.load")({'php.vim', 'vdebug', 'ale', 'vim-php-refactoring-toolbox', 'phpactor', 'vim-twig', 'vim-php-cs-fixer'}, { ft = "php" }, _G.packer_plugins)]]
