...
vim.cmd [[au FileType php ++once lua require("packer.load")({'ale', 'vdebug', 'vim-php-cs-fixer', 'phpactor', 'vim-twig', 'vim-php-refactoring-toolbox', 'php.vim'}, { ft = "php" }, _G.packer_plugins)]]
