...
vim.cmd [[au FileType php ++once lua require("packer.load")({'ale', 'vdebug', 'vim-php-cs-fixer', 'vim-php-refactoring-toolbox', 'vim-twig', 'coc-intelephense', 'php.vim', 'phpactor'}, { ft = "php" }, _G.packer_plugins)]]
