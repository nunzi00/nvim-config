...
vim.cmd [[au FileType php ++once lua require("packer.load")({'phpactor', 'ale', 'php.vim', 'vim-twig', 'vdebug', 'vim-php-refactoring-toolbox', 'vim-php-cs-fixer'}, { ft = "php" }, _G.packer_plugins)]]
