...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vdebug', 'vim-php-cs-fixer', 'vim-php-refactoring-toolbox', 'vim-twig', 'coc-intelephense', 'php.vim', 'phpactor', 'ale'}, { ft = "php" }, _G.packer_plugins)]]
